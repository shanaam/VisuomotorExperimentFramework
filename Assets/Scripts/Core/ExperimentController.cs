...
public class ExperimentController : MonoBehaviour
{
  ...
  /// <summary>
  /// Centers the experiment to the current hand position
  /// Called by BaseTask
  /// </summary>  
  ...
  /// <summary>
  /// Called at the beginning of each trial. Called via UXF
  /// Each case represents a different experiment type
  /// </summary>
    ...
    switch (Session.settings.GetString("experiment_mode"))
    {
      ...
      case "pinball2":
        switch (per_block_type)
        {
          ...
          case "rotated":
          case "clamped":
            CurrentTask = gameObject.AddComponent<Pinball2Task>();
